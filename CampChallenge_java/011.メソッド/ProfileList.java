...
public class ProfileList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProfileList</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProfileList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
HashMap<String, String>ProfList(){
    HashMap<String, String>Prof =
        new HashMap<String, String>();
    Prof.put("ID", "123");
    Prof.put("名前", "今村");
    Prof.put("生年月日", "1984年2月21日");
    Prof.put("住所", "東京都");
